...
class TuneHubProvider(LyricsProviderBase):
    """Provider for TuneHub API.
    
    This is the original lyrics API used by LyricFlow.
    API documentation: https://music-dl.sayqz.com
    """
